  ...
  <aside class="aside-menu">
    <b-tabs>
      ...
      <b-tab>
        ...
        <div class="p-3">
          <h6 class="text-primary">用戶基本資料</h6>  
            <b-list-group flush>
                <b-list-group-item>廠別代號： {{PubCompanyId}}</b-list-group-item>
                <b-list-group-item>公司代號： {{CompanyNo}}</b-list-group-item>
                <b-list-group-item>部門代號： {{OrgNodeNo}}</b-list-group-item>
                <b-list-group-item>部門： {{OrgNodeName}}</b-list-group-item>
                <b-list-group-item>工號： {{EmpNo}}</b-list-group-item>
                <b-list-group-item variant="primary">姓名： {{UserName}}</b-list-group-item>
                <b-list-group-item>UID： {{UID}}</b-list-group-item>
                <b-list-group-item>職位：</b-list-group-item>
...
export default {
  ...
  data(){
    return {
      ...
      CompanyNo: this.$store.getters.company_no,
      UserName: this.$store.getters.name,
      UID: this.$store.getters.uid,
      EmpNo: this.$store.getters.emp_no,
      OrgNodeNo: this.$store.getters.org_node_no,
      OrgNodeName:this.$store.getters.org_node_name,
