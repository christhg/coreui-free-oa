...
export default {
  data () {
    return {
          ...
          tableConfig: {
                        ...
                        tableData: [],
                        columns:  [
                                {field: 'ORG_LEVEL', title:'組織層級', width: 80, titleAlign: 'center',columnAlign:'center',isEdit:false,
                                ...
                                {field: 'MGR_EMP_NO', title: '管理者工號', width: 80, titleAlign: 'center',columnAlign:'left',isEdit:true,isResize:true,
                                isResize:true,titleCellClassName:'title-cell-class-name-test',columnCellClassName:'column-cell-class-name-test'},
                                {field: 'MGR_EMP_NAME', title: '管理者姓名', width: 80, titleAlign: 'center',columnAlign:'center',isEdit:true,
                                isResize:true,titleCellClassName:'title-cell-class-name-test'},
                                {field: 'PROXY_EMP_NO', title: '代理人工號', width: 80, titleAlign: 'center',columnAlign:'left',isEdit:true,isResize:true},
                                {field: 'PROXY_EMP_NAME', title: '代理人姓名', width: 80, titleAlign: 'center',columnAlign:'center',isEdit:true},
                                {field: 'UP_ORG_NODE_NO', title: '上級組織代號', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,isResize:true},
                                {field: 'FI_ORG_NODE_NO', title: '財務組織代號', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:false,isResize:true}
                        ]
          },
          isLoading: false,
          searchtxt:''
  ...
  methods: {
    ...
    getTableData(){
        ...
        this.isLoading = true;
        getPagesOrgs (200,this.pageIndex,this.pageSize)
        .then(response =>{
    ...
    fetchData(){
        this.isLoading = true;
        getPagesOrgs (200, this.pageIndex,this.pageSize).then(response =>{
